#!/usr/bin/env python3
"""
Simplified unit tests for the DINOv2Extractor.
"""
import os
import sys
...
from source.embedder import DINOv2Extractor

class TestDINOv2Extractor:
    """Simplified test suite for DINOv2Extractor."""

    @pytest.fixture
    def extractor(self):
        """Create a DINOv2Extractor instance for testing."""
    ...
    def test_initialization(self, extractor):
        ...
        assert extractor.model_name == "dinov2_vitb14"
