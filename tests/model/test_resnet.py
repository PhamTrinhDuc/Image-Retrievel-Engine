#!/usr/bin/env python3
"""
Simplified unit tests for the ResNetExtractor.
"""
import os
import sys
...
from source.models import ResNetExtractor

class TestResNetExtractor:
    """Simplified test suite for ResNetExtractor."""

    @pytest.fixture
    def extractor(self):
        """Create a ResNetExtractor instance for testing."""
